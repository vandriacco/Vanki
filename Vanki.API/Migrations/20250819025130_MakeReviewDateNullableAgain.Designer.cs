...
namespace Vanki.API.Migrations
{
    ...
    [Migration("20250819025130_MakeReviewDateNullableAgain")]
    partial class MakeReviewDateNullableAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vanki.API.Models.Card", b =>
                {
                    b.HasOne("Vanki.API.Models.Deck", "Deck")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("Vanki.API.Models.Deck", b =>
                {
                    b.HasOne("Vanki.API.Models.User", "User")
                        .WithMany("Decks")
